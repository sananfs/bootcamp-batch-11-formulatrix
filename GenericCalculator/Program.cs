	...
	static void Main()
	{
		...
		do
		{
			...
			if (menu == "1")
			{
				...
				int result = Calculator<int>.Add(inputUserInt, inputUserInt2);
				Console.WriteLine("Hasil = " + result);
			}
			if (menu == "2")
			{
				//Call calculator method
				int result = Calculator<float>.Min(inputUserInt, inputUserInt2);
				Console.WriteLine("Hasil = " + result);
			}
			if (menu == "3")
			{
				int result = Calculator<decimal>.Multiply(inputUserInt, inputUserInt2);
				Console.WriteLine("Hasil = " + result);
			}
			if (menu == "4")
			{
				int result = Calculator<double>.Divided(inputUserInt, inputUserInt2);
				Console.WriteLine("Hasil = " + result);
			}
